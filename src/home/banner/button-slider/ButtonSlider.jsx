    ...
    <div className='container-button my-4  p-3  justify-center items-center w-full text-gray-900'>
      ...
      >
        <svg
          ...
          height='40'
          viewBox='0 0 50 50'
          className=' fill-current   sm:m-auto'
        >
      ...
      <a className='link-together mr-2  hover:underline hover:text-green-700 cursor-pointer'>
        <ShoppingBagIcon className='icones-together h-10 w-10 sm:m-auto fill-current ' />
        Cotización
      </a>
      <a
      ...
      >
        <PhoneIcon className='icones-together h-10 w-10 sm:m-auto fill-current ' />{' '}
        Venta Telefónica
      </a>
      <a className='link-together mr-2  hover:underline hover:text-green-700 cursor-pointer'>
        <HomeIcon className='icones-together h-10 2-5 sm:m-auto fill-current ' />
        Nuestra Tienda
      </a>
    </div>
  )
