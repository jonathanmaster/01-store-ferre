import { HomeIcon, PhoneIcon, ShoppingBagIcon } from '@heroicons/react/20/solid'
import './style.css'

export const ButtonSlider = () => {
  return (
    <div className='container-button my-4  p-3  justify-center items-center w-full text-gray-900'>
      <a
        className='link-together mr-2 hover:underline hover:text-green-700 cursor-pointer '
      ...
      >
        <svg
          ...
          height='40'
          viewBox='0 0 50 50'
          className=' fill-current text-blue-500  sm:m-auto'
        >
      ...
      <a className='link-together mr-2  hover:underline hover:text-green-700 cursor-pointer'>
        <ShoppingBagIcon className='icones-together h-10 w-10 sm:m-auto fill-current text-blue-500' />
        Cotización
      </a>
      <a
        className='link-together hover:underline hover:text-green-700 cursor-pointer '
        href='tel: +573124488144'
      >
        <PhoneIcon className='icones-together h-10 w-10 sm:m-auto fill-current text-blue-500' />
        Venta Telefónica
      </a>
      <a className='link-together mr-2  hover:underline hover:text-green-700 cursor-pointer'>
        <HomeIcon className='icones-together h-10 2-5 sm:m-auto fill-current text-blue-500' />
        Nuestra Tienda
      </a>
    </div>
  )
