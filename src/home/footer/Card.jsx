...
const posts = [
  {
    ...
    description: 'Más de 200 mil artículos a precios muy competitivos',
    author: {
      name: 'Michael Foster',
      role: 'Co-Founder / CTO',
      href: '#',
      icon: <CurrencyDollarIcon className='h-8 w-8 text-blue-700' />,
    },
  },
  {
    id: 2,
    ...
    author: {
      ...
      role: 'Co-Founder / CTO',
      href: '#',
      icon: <CreditCardIcon className='h-8 w-8 text-blue-700' />,
    },
  },
  {
    id: 3,
    ...
    author: {
      ...
      role: 'Co-Founder / CTO',
      href: '#',
      icon: <ShieldCheckIcon className='h-8 w-8 text-blue-700' />,
    },
  },
  {
    id: 4,
