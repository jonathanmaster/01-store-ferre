...
export const ButtonSlider = () => {
  return (
    <div className='container-button my-4 p-4 gap-4 justify-center m-auto items-center text-center max-w-2xl text-gray-900 bg-white rounded-md'>
      <a
      ...
      >
        <svg
          ...
          height='40'
          viewBox='0 0 50 50'
          className=' fill-current text-green-500  sm:m-auto'
        >
      ...
      <a className='   hover:underline hover:text-green-500 cursor-pointer '>
        <ShoppingBagIcon className='ic h-10 w-10 sm:m-auto fill-current text-blue-500' />
        Cotización
      </a>
      <a
        className=' hover:underline hover:text-green-700 cursor-pointer  '
      ...
      >
        <PhoneIcon className='ic h-10 w-10 sm:m-auto fill-current text-gray-900' />
        Venta Telefónica
      </a>
      <a className='   hover:underline hover:text-green-700 cursor-pointer '>
        <HomeIcon className='ic h-10 2-5 sm:m-auto fill-current text-blue-500' />
        Nuestra Tienda
      </a>
    </div>
  )
